...
def print_strategy_comparison(summaries: list):
    """Print side-by-side comparison of both CV strategies."""
    print(f"\n{'=' * 90}")
...
def main():
    """Main pipeline: GKF and SKF strategies compared using deep learning."""
    print("\n" + "=" * 90)
    ...
    # ── STEP 4: Feature importance (from GKF, primary benchmark) ─────
    print("\n" + "─" * 90)
    ...
    # ── STEP 5: Save model checkpoint for inference ───────────────────
    print("\n" + "─" * 90)
